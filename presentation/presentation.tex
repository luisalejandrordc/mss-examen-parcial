...
\begin{frame}{Pregunta 3: Generación de Variables Aleatorias (ACL)}
	\begin{exampleblock}{Periodo de Vida}
		...
		\begin{center}
			...
			\begin{tabular}{cll}
				\toprule
				\textbf{Parámetro} & \textbf{Condición}                                   & \textbf{Razón} \\
				\midrule
				$m$                & $m = 2^{g}$, \;$g$ entero
				                   & Módulo potencia de 2                                                  \\
				$a$                & $a = 1 + 4k$, \;$k$ entero \;($a \equiv 1 \pmod{4}$)
				                   & Garantiza ciclo completo                                              \\
				$c$                & $\gcd(c,\,m) = 1$
				                   & $c$ debe ser impar (ya que $m=2^g$)                                   \\
				$X_0$              & $0 < X_0 < m$, entero
				                   & Cualquier semilla válida                                              \\
				\bottomrule
			\end{tabular}
		\end{center}
	\end{exampleblock}
...
\begin{frame}{Pregunta 3: Generación de Variables Aleatorias (ACL)}
	...
	\begin{exampleblock}{Selección de Parámetros}
		\[
			X_0 = 55 \qquad a = 37 \qquad c = 19 \qquad m = 2^7 = 128
		\]
		\begin{center}
			\renewcommand{\arraystretch}{1.3}
			\begin{tabular}{clll}
				\toprule
				\textbf{Condición} & \textbf{Requisito}                       & \textbf{Cálculo} & \\
				\midrule
				$m = 2^g$
				                   & $g$ entero
				                   & $m = 2^7 = 128$
				...
				$a = 1+4k$
				                   & $k$ entero
				                   & $a = 1 + 4(9) = 37$, \; $37 \bmod 4 = 1$
				                   & \checkmark                                                    \\
				$\gcd(c,m)=1$
				                   & $c$ impar
				                   & $\gcd(19,\,128) = 1$ \;(19 primo)
				                   & \checkmark                                                    \\
				$0 < X_0 < m$
				                   & entero positivo
				                   & $0 < 55 < 128$
			...
			\end{tabular}
		\end{center}
		\textbf{Periodo de vida garantizado:} $N \;=\; m \;=\; 2^7 \;=\; \mathbf{128}$
	\end{exampleblock}
\end{frame}
...
\begin{frame}{Pregunta 3: Generación de Variables Aleatorias (ACL)}
	...
	\begin{center}
		...
		\begin{tabular}{cccccc}
			\toprule
			$i$ & $X_{i-1}$ & $a \cdot X_{i-1}$ & $+\,c$ & $X_i \bmod 128$ & $r_i = X_i/127$ \\
			\midrule
