...
\begin{frame}{Pregunta 5: Validación Estadística — Prueba de Varianza}
	\begin{exampleblock}{Cálculo de la Varianza y Límites}
		\begin{itemize}
			\item Grados de libertad: $gl = n - 1 = 99$
			\item Cuantiles Chi-cuadrada \textnormal{(tabla)}:
			      \[
				      \chi^2_{0.025,\;99} = 128.422
				      \qquad
				      \chi^2_{0.975,\;99} = 73.361
			      \]
		\end{itemize}
		\textbf{Parámetros:} $n = 100$,\; $\alpha = 0.05$,\;
		$z_{0.025} = 1.96$ \textnormal{(tabla Chi-Cuadrado)}\\[6pt]
...
\begin{frame}{Pregunta 5: Validación Estadística — Prueba de Varianza}
	\textbf{Promedio muestral ya calculado:} $\bar{r} = 0.4657$.\\[6pt]

	\textbf{Estadístico de prueba} \textnormal{(Ref.\ Cap.\ 2.4.2)}:
	\[
		V(r) \;=\; \frac{\displaystyle\sum_{i=1}^{n}(r_i - \bar{r})^2}{n-1}
	\]

	Se usa $n-1$ en el denominador (corrección de Bessel) para obtener
	un estimador \textbf{insesgado} de $\sigma^2$: dividir por $n$
	subestimaría sistemáticamente la varianza poblacional.

\end{frame}

\begin{frame}{Pregunta 5: Validación Estadística — Prueba de Varianza}
	\textbf{Parámetros de la prueba:}

\end{frame}


% ─────────────────────────────────────────────────────────────────────────────
% SLIDE 6 — Aplicación Numérica
% ─────────────────────────────────────────────────────────────────────────────
\begin{frame}{Pregunta 5: Validación Estadística — Prueba de Varianza}
...
\begin{frame}{Pregunta 5: Validación Estadística — Prueba de Varianza}
	...
	\begin{center}
		...
		\begin{tabular}{lc}
			...
			$\chi^2_{0.025,\;99}$           & 128.422         \\
			$\chi^2_{0.975,\;99}$           & 73.361          \\
			Varianza teórica $1/12$         & 0.08333         \\
			Varianza muestral $V(r)$        & 0.08097         \\
			Límite inferior $LI$            & 0.06174         \\
			Límite superior $LS$            & 0.10810         \\
			$V(r) \in [LI,\,LS]$?           & Sí\; \checkmark \\
			\bottomrule
		\end{tabular}
	\end{center}
